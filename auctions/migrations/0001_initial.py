    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('short', models.CharField(blank=True, max_length=32)),
                ...
                ('winner', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, related_name='winnings', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Comment',
